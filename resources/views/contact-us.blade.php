            ...
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    ...
                    <div class="contact-info">
                        <h2>{{__('Hotline')}} : <span class="text-primary" onclick="location.href='tel:+918758422436';">+91 8758422436</span> </h2>
                        <p onclick="location.href='mailto:karanranparia@gmail.com';"><i class="icon ion-md-mail"></i> karanranparia@gmail.com</p>
                        <p><i class="icon ion-md-pin"></i> Bhagyalaxmi Industrial Estate,St. no 2, Bhavnagar Rd, Rajkot (<a href="https://g.page/ranparia-engineering-co?share" class="text-primary" target="_blank">{{__('View map')}}</a>)</p>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="text-center">
                        <a href="https://g.page/ranparia-engineering-co?share" class="btn btn-primary btn-m-r" target="_blank">{{__('Get derection')}}</a>
                        <a href="https://g.page/ranparia-engineering-co?share" class="btn btn-border" target="_blank">{{__('Google Map')}}</a>
                    </div>
                </div>
            </div>
        </div>
