...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <div id="bussness-inquiry" onclick="location.href='https://api.whatsapp.com/send?phone=918758422436';" aria-label="Business Enquiry" style="opacity: 1;">Business Enquiry</div>
        @yield('content')
